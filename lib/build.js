...
function buildApp(appPath, buildLocaltion, buildOptions,serverURL, callback) {
  buildMeteorApp(appPath, buildLocaltion, buildOptions,serverURL, function(code) {
    if(code == 0) {
...
function buildMeteorApp(appPath, buildLocaltion, buildOptions,serverURL, callback) {
